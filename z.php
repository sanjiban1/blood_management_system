					...
					<div class="add-car-area">
						<div class="row">
							<div class="information-form">
								...
								<form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process1.php" method="post" id="paypal_form" target="_blank">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Choose a plan" class="form-control chosen-select" name="pricing_plan_id" required>
												<option></option>
												<?php
										...
										<div class="form-group col-md-6 col-sm-6">
											...
											<input autocomplete="off" type="text" class="form-control datepicker" name="payment_date" placeholder="Payment Date" value="<?php echo date('Y-m-d'); ?>" required>
										</div>
									</div>
