                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
							...
							<option value="Testimonial Page Layout" <?php if($page_layout=='Testimonial Page Layout') {echo 'selected';} ?>>Testimonial Page Layout</option>
							<option value="Donor Page Layout" <?php if($page_layout=='Donor Page Layout') {echo 'selected';} ?>>Donor Page Layout</option>
							<option value="Agent Page Layout" <?php if($page_layout=='Agent Page Layout') {echo 'selected';} ?>>Agent Page Layout</option>
							<option value="Pricing Page Layout" <?php if($page_layout=='Pricing Page Layout') {echo 'selected';} ?>>Pricing Page Layout</option>
