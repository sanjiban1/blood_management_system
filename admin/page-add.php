						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
									...
									<option value="Testimonial Page Layout">Testimonial Page Layout</option>
									<option value="Donor Page Layout">Donor Page Layout</option>
									<option value="Agent Page Layout">Agent Page Layout</option>
									<option value="Pricing Page Layout">Pricing Page Layout</option>
